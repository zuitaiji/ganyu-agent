...
- [install.md](install.md) — 安装：一键脚本 / cargo / 源码 + 特性矩阵 + 卸载 + FAQ

## 指南
- [config-guide.md](config-guide.md) — **配置模型指导**：env 全量清单 + 4 个场景模板（离线/开发/生产/容器）+ 基线自检
- [usage.md](usage.md) — CLI 使用：子命令 + 示例 + FAQ
- [development.md](development.md) — 开发：构建 / 测试 / 特性 / 扩展 / 约定 / 贡献
